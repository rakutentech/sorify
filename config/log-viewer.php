...
return [
    ...
    */
    ...
    'include_files' => [
        ...
        // Not used: this app runs on FrankenPHP, and /var/log/nginx|httpd/* on the
        // prod host are root-owned and unreadable by the app user, which crashes
