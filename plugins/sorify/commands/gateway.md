...
| `get_run_status` | `run_id` | Lightweight poll: status, status_note (why a run is pending/failed, e.g. pre-run integration waiting or failure), passed/failed/error counts, duration — prefer this while polling |
