...
import { Sun, Moon, Mail, Lock, LogIn } from '@lucide/vue';
    ...
    <div class="min-h-screen bg-[var(--md-sys-color-surface)] flex items-center justify-center px-4">
        ...
        <div class="w-full max-w-sm">
            ...
            <div class="text-center mb-8">
                ...
                <p class="mt-2 md-body-medium text-[var(--md-sys-color-on-surface-variant)] flex items-center justify-center gap-2"><LogIn :size="16" :style="{ color: 'var(--md-sys-color-primary)' }" />{{ t('auth.signInSubtitle') }}</p>
            </div>
            ...
            <Card variant="elevated" padding="p-6">
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    >
                        ...
                        {{ t('auth.signInWithApp', { name: app.name }) }}
                    </a>
                </form>
