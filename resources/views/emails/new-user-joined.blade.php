                    ...
                    <tr>
                        <td style="padding:16px 24px;border-bottom:1px solid #e0e0e0;">
                            ...
                            <p style="margin:0;font-size:13px;color:#757575;">
                                @if ($source === 'admin')
                                    Created by an administrator{{ $createdByName ? " ({$createdByName})" : '' }}.
                                @elseif ($source === 'github')
                                    Joined via GitHub sign-in.
                                @else
                                    Joined by self-registration.
                                @endif
                            </p>
                            <p style="margin:12px 0 0;">
                                <a href="{{ $usersUrl }}" style="display:inline-block;padding:8px 16px;background:#b3261e;color:#ffffff;text-decoration:none;border-radius:16px;font-size:13px;">Manage Users</a>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:12px 24px;font-size:12px;color:#9e9e9e;">
                            You received this email because you are an administrator of Sorify.
                        </td>
                    </tr>
                </table>
            </td>
